...
WebUI.setText(findTestObject('opensource-demo/Page_Login/txt_Username'), 'Admin1')
WebUI.verifyElementAttributeValue(findTestObject('opensource-demo/Page_Login/txt_Username'), 'value','Admin1',1)
